 ...
 const getAIResponse = (message) => {
  ...
  return (
    <div className="font-sans bg-white text-gray-800 relative overflow-hidden">
      ...
      {/* Navigation */}
      <nav className="relative z-10 p-6 flex justify-between items-center bg-white border-b border-gray-300 shadow-sm">
  ...
  <div className="bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-4 py-2 rounded-full font-medium hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 cursor-pointer">
  <a className="bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-4 py-2 rounded-full font-medium hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 cursor-pointer" href="https://drive.google.com/file/d/1u12VQo7UlR_64m9-lU0Zc4DbgASlWDQS/view">Resume</a>
      ...
      <section id="home" className="relative z-10 min-h-screen flex items-center justify-center px-6">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://drive.google.com/file/d/1u12VQo7UlR_64m9-lU0Zc4DbgASlWDQS/view">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        {isChatOpen && (
          <div className="mb-4 w-96 h-96 bg-black/90 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl shadow-purple-500/20 flex flex-col">
            {/* Chat Header */}
